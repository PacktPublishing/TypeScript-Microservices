...
export class ProductsController {
  ...
  */
    ...
    async getProductsList(): Promise<any> {
        //TODO: write code for getting all products listing.
        return {"productsList":[]};
    }
   ...
   */ 
    ...
    @OnUndefined(404)
    async getProductById(@Param("productId") productId: number,@Req() req:any,@Res() res:any): Promise<any> {
       //TODO: findById
        let result:any=this.productDataAgent.getProductById("999abc");
